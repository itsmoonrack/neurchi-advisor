...
public final class RemoveGroupFromGroupCommand {

    private String tenantId;
    private String childGroupName;
    private String parentGroupName;

    public RemoveGroupFromGroupCommand(final String tenantId, final String parentGroupName, final String childGroupName) {
