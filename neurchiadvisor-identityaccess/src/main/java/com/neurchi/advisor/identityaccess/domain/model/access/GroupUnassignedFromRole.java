...
public final class GroupUnassignedFromRole implements DomainEvent {
    ...
    GroupUnassignedFromRole(final TenantId tenantId, final String roleName, final String groupName) {
