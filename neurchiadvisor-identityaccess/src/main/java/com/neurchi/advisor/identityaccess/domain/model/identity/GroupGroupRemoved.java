...
public final class GroupGroupRemoved implements DomainEvent {
    ...
    GroupGroupRemoved(final TenantId tenantId, final String groupName, final String nestedGroupName) {
